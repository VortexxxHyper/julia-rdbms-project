...
# !!! Main.UserApp is configured as an alias for Main.SearchLightDemo and you might encounter it in some tests
using Main.SearchLightDemo, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "SearchLightDemo tests" begin
  @includetests ARGS
end
